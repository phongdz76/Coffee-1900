...
function renderAuthActions() {
  if (!desktopAuthActions || !mobileAuthActions) {
    return;
  }
  ...
  if (!currentUser) {
    desktopAuthActions.innerHTML = `
      ...
      <a href="./pages/auth/signup.html" class="btn-signup">Đăng Ký</a>
    `;
  ...
  desktopAuthActions.innerHTML = `
    <span class="auth-greeting">Xin chào, ${displayName}</span>
    <a href="#" class="btn-login js-logout-link">Đăng Xuất</a>
  `;
  ...
  document.querySelectorAll(".js-logout-link").forEach((logoutLink) => {
...
function initAnimations() {
  ...
  const animateElements = document.querySelectorAll(
    ".feature-card, .product-card, .blog-card, .gallery-item",
  );
...
function showQuickView(productId, name, description, price, image) {
